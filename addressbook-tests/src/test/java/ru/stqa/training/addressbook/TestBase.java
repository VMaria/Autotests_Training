...
public class TestBase {
    ...
    protected void fillContactForm(ContactData contactData) {
        ...
        if (!wd.findElement(By.xpath(contactData.getDay())).isSelected()) {
            wd.findElement(By.xpath(contactData.getDay())).click();
        }
        if (!wd.findElement(By.xpath(contactData.getMonth())).isSelected()) {
            wd.findElement(By.xpath(contactData.getMonth())).click();
        }
